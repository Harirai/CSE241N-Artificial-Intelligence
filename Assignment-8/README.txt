...
Actual Work:
------------
- Complete the functions related to search according to the given algorithms. Fill in the definitions of the functions 'breadthFirstSearch', 'depthFirstSearch', 'searchHillClimbing', 'searchBeam', 'searchBestFirst', and 'searchAStar' in 'search.py'.
...
3. You need to submit the file: 'search.py'. Make a folder of your roll no containing only 'search.py' file
IMPORTANT:
----------
